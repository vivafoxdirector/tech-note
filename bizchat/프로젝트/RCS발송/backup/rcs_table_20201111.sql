...
CREATE TABLE SURVEY_RCS(
    ...
    RCS_MSG_TYPE            VARCHAR(10) NOT NULL,    /* RCS 메시지 타입 */
    SLIDE_CNT               NUMBER(3) NOT NULL,    /* 슬라이드 개수 */
    FOOTER_PHONE_NUM        VARCHAR2(20) NOT NULL,  /* 푸터 번호 */  
