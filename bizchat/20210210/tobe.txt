...
import com.skt.mate.model.domain.survey.SurveyRcsBtnVO;
import com.skt.mate.model.domain.survey.SurveyRcsVO;
...
public class SurveyController {
    ...
    public void downloadSurvey(HttpServletResponse response, Model model
        ...
        /** RCS S RCS정보 취득*/
        SurveyRcsVO surveyRcs = surveyMgmtService.getSurveyRcsInfo(surveyInfo.getSurveySeq());
        List<SurveyRcsBtnVO> surveyRcsBtnList = surveyMgmtService.getSurveyRcsBtnInfo(surveyRcs.getRcsSeq());
        /** RCS E */
        ...
        List<AnsVO> answerList = new ArrayList<>();
        if (qustSeq.size() > 0) {
        	answerList = surveyMgmtService.getSurveyAnswerListByQustId(qustSeq);
        }
        ...
        /** RCS S */
        if (surveyRcs != null) {
        	excelModel.addAttribute("surveyRcsInfo", surveyRcs);
        	for (SurveyRcsBtnVO vo : surveyRcsBtnList) {
        		int no = vo.getRcsSliceOrd();
        		switch(no) {
        		case 1:
        			surveyRcs.setSurveyRcsBtn1(vo);
        			break;
        		case 2:
        			surveyRcs.setSurveyRcsBtn2(vo);
        			break;
        		case 3:
        			surveyRcs.setSurveyRcsBtn3(vo);
        			break;
        		case 4:
        			surveyRcs.setSurveyRcsBtn4(vo);
        			break;
        		case 5:
        			surveyRcs.setSurveyRcsBtn5(vo);
        			break;
        		case 6:
        			surveyRcs.setSurveyRcsBtn6(vo);
        			break;
        		}
        	}
        }
